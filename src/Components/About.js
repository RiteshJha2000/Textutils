...
export default function About() {
  ...
  <div className="accordion-item" style={mystyle}>
    ...
    {/* <button type="button" className="btn btn-primary" onClick={handlemode}>{mybtn}</button> */}
    <div className="form-check form-switch">
  <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={handlemode}/>
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault" style={mystyle}>{mybtn}</label>
</div>
    </div>
        </div>
    )
